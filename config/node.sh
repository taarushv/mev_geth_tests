...
if [[ $1 = "start" ]]; then
  ...
  geth -datadir /home/user/data -bootnodes $bootnode --nousb --networkid 500 --override.london 0 --mine --miner.threads=8 --miner.etherbase=0xfb05314AD5f12968Fa71C0c944aA376C5f3316D5 --miner.maxmergedbundles=4 --miner.trustedrelays=0xfb11e78C4DaFec86237c2862441817701fdf197F --rpc --rpccorsdomain "*" --rpcapi "eth,web3,personal,net" --rpcaddr "0.0.0.0" --allow-insecure-unlock 2>> $LOG &
  sleep 2
